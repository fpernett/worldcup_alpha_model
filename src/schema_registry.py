...
EXPECTED_CSV_SCHEMAS: dict[str, list[str]] = {
    ...
    "data/raw/fifa_snapshot_missing_teams.csv": [
        "team",
        "fifa_rank",
        "fifa_points",
        "source",
    ...
    "data/tournament_learning_ledger.csv": [
        "learning_id",
        "created_utc",
        "match_id",
        "date_utc",
...
MODEL_DEFINITION_FILES: set[str] = {
    ...
    "src/backtest.py",
    "src/asof_backtest.py",
    "src/blend_sensitivity.py",
    "src/prediction_ledger.py",
    "src/prediction_log_repair.py",
    "src/postmortem.py",
    ...
    "src/fifa_snapshot_validation.py",
}
...
API_SOURCE_FILES: set[str] = {
    ...
    "src/odds.py",
    "src/polymarket.py",
    "src/polymarket_match_search.py",
    "src/polymarket_sports_discovery.py",
    "src/polymarket_url_resolver.py",
    "src/cache.py",
    "src/historical_data.py",
    "src/historical_binding.py",
    "src/fixture_diagnostics.py",
